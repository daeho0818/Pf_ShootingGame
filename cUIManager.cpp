...
void cUIManager::CenterRender(cTexture* ptr, Vec2 pos, float size)
{
	D3DXMATRIXA16 mat;
	D3DXMatrixAffineTransformation2D(&mat, 1 * size, nullptr, 0, &Vec2(pos.x - ptr->info.Width / 2, pos.y - ptr->info.Height / 2));
